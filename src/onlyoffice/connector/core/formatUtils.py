...
def getSupportedFormats():
    return [
        ...
        Format("oxps", "word", convertTo = ["pdf", "pdfa"]),
        Format("pdf", "word"),
        Format("rtf", "word", convertTo = ["docm", "docx", "docxf", "dotm", "dotx", "epub", "fb2", "html", "odt", "ott", "pdf", "pdfa", "txt"]),
        Format("txt", "word", convertTo = ["docm", "docx", "docxf", "dotm", "dotx", "epub", "fb2", "html", "odt", "ott", "pdf", "pdfa", "rtf"]),
        Format("xps", "word", convertTo = ["pdf", "pdfa"]),
        ...
        Format("csv", "cell", convertTo = ["ods", "ots", "pdf", "pdfa", "xlsm", "xlsx", "xltm", "xltx"]),
